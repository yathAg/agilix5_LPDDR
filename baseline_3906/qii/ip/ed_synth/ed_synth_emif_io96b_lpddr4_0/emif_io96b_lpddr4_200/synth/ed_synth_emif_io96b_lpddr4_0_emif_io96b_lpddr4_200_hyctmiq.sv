...
module ed_synth_emif_io96b_lpddr4_0_emif_io96b_lpddr4_200_hyctmiq #(
      ...
      begin: arch_emif_1
         if (MEM_NUM_IO96 == 2) begin: arch1_exists
            if (MEM_NUM_CHANNELS_PER_IO96 == 2) begin: arch1_2ch_per_io 
               ...
               io1_ed_synth_emif_io96b_lpddr4_0_emif_io96b_lpddr4_200_hyctmiq_io96b_top #(
                  .PHY_NOC_EN                (PHY_USE_NOC_INTF         ),
   ...
   generate 
      begin: io0
      // {{{ cal_0
      ed_synth_emif_io96b_lpddr4_0_emif_io96b_lpddr4_emif_io96b_cal_200_ogvmehq calip_0 (
