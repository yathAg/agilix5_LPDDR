...
module ed_synth_axil_driver_0_emif_ph2_axil_driver_100_qakapty_axil_driver_top
#(
...
(
   ...
   read_state_type r_fsm_cs = WAIT_NOC_INIT;
   read_state_type c_fsm_ns = WAIT_NOC_INIT;
