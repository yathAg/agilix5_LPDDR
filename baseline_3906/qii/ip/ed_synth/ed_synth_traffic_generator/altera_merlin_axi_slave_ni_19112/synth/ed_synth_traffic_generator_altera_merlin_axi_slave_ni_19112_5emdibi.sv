...
module ed_synth_traffic_generator_altera_merlin_axi_slave_ni_19112_5emdibi
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    ed_synth_traffic_generator_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_3oiloga #(
        .SYMBOLS_PER_BEAT    (1),
