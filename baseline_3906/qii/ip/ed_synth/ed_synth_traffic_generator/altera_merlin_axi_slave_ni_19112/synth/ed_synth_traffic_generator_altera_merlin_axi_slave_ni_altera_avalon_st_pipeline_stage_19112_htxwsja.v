// ed_synth_traffic_generator_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_htxwsja.v

// Generated using ACDS version 24.3.1 102

`timescale 1 ps / 1 ps
module ed_synth_traffic_generator_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_htxwsja #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 129,
		...
		input  wire [128:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		...
		output wire [128:0] out_data           //          .data,          Output Data port of Avalon Streaming Source Interface
	);

	ed_synth_traffic_generator_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 129,          .data
		...
		.out_data          (out_data),          //  output,  width = 129,          .data
