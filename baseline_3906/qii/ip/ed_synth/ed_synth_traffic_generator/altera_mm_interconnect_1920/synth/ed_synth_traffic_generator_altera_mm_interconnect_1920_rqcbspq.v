// ed_synth_traffic_generator_altera_mm_interconnect_1920_rqcbspq.v
...
`timescale 1 ps / 1 ps
module ed_synth_traffic_generator_altera_mm_interconnect_1920_rqcbspq (
	...
	ed_synth_traffic_generator_altera_merlin_apb_translator_1920_6aahr2a #(
		.ADDR_WIDTH     (12),
		.DATA_WIDTH     (32),
		.USE_S0_PADDR31 (1),
		.USE_M0_PADDR31 (0),
	...
	ed_synth_traffic_generator_altera_merlin_axi_master_ni_19100_y3ctica #(
		.ID_WIDTH                  (1),
		.ADDR_WIDTH                (12),
		.RDATA_WIDTH               (32),
		.WDATA_WIDTH               (32),
	...
	ed_synth_traffic_generator_altera_merlin_apb_slave_agent_1940_4j3b5gq #(
		.ADDR_WIDTH                (12),
		.DATA_WIDTH                (32),
		.PKT_DATA_H                (31),
		.PKT_DATA_L                (0),
	...
	ed_synth_traffic_generator_altera_merlin_router_1921_iegcfmq router (
	...
	ed_synth_traffic_generator_altera_merlin_router_1921_iegcfmq router_001 (
	...
	ed_synth_traffic_generator_altera_merlin_router_1921_ah5veci router_002 (
	...
	ed_synth_traffic_generator_altera_merlin_demultiplexer_1921_bcyqn7i cmd_demux (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_synth_traffic_generator_altera_merlin_demultiplexer_1921_bcyqn7i cmd_demux_001 (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_synth_traffic_generator_altera_merlin_multiplexer_1922_faztmpq cmd_mux (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_synth_traffic_generator_altera_merlin_demultiplexer_1921_lpkcrti rsp_demux (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_synth_traffic_generator_altera_merlin_multiplexer_1922_wwowo6i rsp_mux (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_synth_traffic_generator_altera_merlin_multiplexer_1922_wwowo6i rsp_mux_001 (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
