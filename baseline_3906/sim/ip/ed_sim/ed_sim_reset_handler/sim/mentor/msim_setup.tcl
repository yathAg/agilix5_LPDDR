...
alias com {
  ...
  set common_design_files [dict values [ed_sim_reset_handler::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ed_sim_reset_handler::get_design_files "$QSYS_SIMDIR"]]
