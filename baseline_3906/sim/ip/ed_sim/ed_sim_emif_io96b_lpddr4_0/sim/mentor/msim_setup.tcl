...
alias dev_com {
  ...
  if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib tennm_agilex5_hssi_a_ver "$DEVICES_SIM_LIB_DIR/tennm_agilex5_hssi_a_ncrypt.sv"  -suppress 7061,2583,13314 -end \
...
alias com {
  ...
  set common_design_files [dict values [ed_sim_emif_io96b_lpddr4_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ed_sim_emif_io96b_lpddr4_0::get_design_files "$QSYS_SIMDIR"]]
