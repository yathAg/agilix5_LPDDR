// ed_sim_traffic_generator_altera_mm_interconnect_1920_vtrezla.v
...
`timescale 1 ps / 1 ps
module ed_sim_traffic_generator_altera_mm_interconnect_1920_vtrezla (
	...
	ed_sim_traffic_generator_altera_merlin_master_translator_192_54w642y #(
		.AV_ADDRESS_W                (32),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (1),
		.AV_BYTEENABLE_W             (4),
	...
	ed_sim_traffic_generator_altera_merlin_master_agent_1930_l64uqry #(
		.PKT_WUNIQUE               (110),
		.PKT_DOMAIN_H              (109),
		.PKT_DOMAIN_L              (108),
		.PKT_SNOOP_H               (107),
	...
	ed_sim_traffic_generator_altera_merlin_axi_slave_ni_19112_ykxseta #(
		.PKT_QOS_H                   (86),
		.PKT_QOS_L                   (86),
		.PKT_THREAD_ID_H             (89),
		.PKT_THREAD_ID_L             (89),
	...
	ed_sim_traffic_generator_altera_merlin_axi_slave_ni_19112_5emdibi #(
		.PKT_QOS_H                   (86),
		.PKT_QOS_L                   (86),
		.PKT_THREAD_ID_H             (89),
		.PKT_THREAD_ID_L             (89),
	...
	ed_sim_traffic_generator_altera_merlin_router_1921_lras3ty router (
	...
	ed_sim_traffic_generator_altera_merlin_router_1921_cq4uqsy router_001 (
	...
	ed_sim_traffic_generator_altera_merlin_router_1921_cq4uqsy router_002 (
	...
	ed_sim_traffic_generator_altera_merlin_router_1921_cq4uqsy router_003 (
	...
	ed_sim_traffic_generator_altera_merlin_router_1921_cq4uqsy router_004 (
	...
	ed_sim_traffic_generator_altera_merlin_traffic_limiter_1921_6hyjguq #(
		.SYNC_RESET                           (0),
		.PKT_DEST_ID_H                        (88),
		.PKT_DEST_ID_L                        (88),
		.PKT_SRC_ID_H                         (87),
	...
	ed_sim_traffic_generator_altera_merlin_demultiplexer_1921_yicp2kq cmd_demux (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                                     //   input,    width = 1,        clk.clk
		.reset              (remote_access_jamb_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_multiplexer_1922_avyhzyy cmd_mux (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_multiplexer_1922_avyhzyy cmd_mux_001 (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_multiplexer_1922_avyhzyy cmd_mux_002 (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset               (remote_access_jamb_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_multiplexer_1922_avyhzyy cmd_mux_003 (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset               (remote_access_jamb_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_demultiplexer_1921_qq5eekq rsp_demux (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_demultiplexer_1921_qq5eekq rsp_demux_001 (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (global_csr_axi_bridge_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_demultiplexer_1921_qq5eekq rsp_demux_002 (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset              (remote_access_jamb_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_demultiplexer_1921_qq5eekq rsp_demux_003 (
		.clk                (remote_intf_clk_bridge_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset              (remote_access_jamb_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ed_sim_traffic_generator_altera_merlin_multiplexer_1922_wrdg73y rsp_mux (
		.clk                 (remote_intf_clk_bridge_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset               (remote_access_jamb_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
