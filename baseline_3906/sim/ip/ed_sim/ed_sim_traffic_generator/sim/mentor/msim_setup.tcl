...
alias com {
  ...
  set common_design_files [dict values [ed_sim_traffic_generator::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ed_sim_traffic_generator::get_design_files "$QSYS_SIMDIR"]]
