...
set USER_DEFINED_COMPILE_OPTIONS "-O0"
...
set logical_libraries [list "work" "work_lib" "lpm_ver" "sgate_ver" "altera_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hvio_ver" "tennm_sm_hps_ver" "tennm_agilex5_io96_ver"]
...
alias com {
  ...
  set design_files [concat $design_files [get_design_files "$QSYS_SIMDIR"]]
...
alias elab {
  ...
  eval vsim -suppress 2732 -suppress 1130 -suppress 7041 -suppress 7033 -voptargs=-svext=+adta $elabcommand
}
...
alias elab_debug {
  ...
  foreach library $logical_libraries { append elabcommand " -L $library" }
  append elabcommand " $TOP_LEVEL_NAME $DPI_LIBRARIES_ELAB "
  eval vsim -suppress 2732 -suppress 1130 -suppress 7041 -suppress 7033 -voptargs=-svext=+adta -voptargs=+acc $elabcommand
}
