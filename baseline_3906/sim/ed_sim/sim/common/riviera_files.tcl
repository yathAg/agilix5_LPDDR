source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_user_pll/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_async_clk_source/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_axil_driver_0/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_mem/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_ref_clk_source_0/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_rrip/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_traffic_generator/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_reset_handler/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_emif_io96b_lpddr4_0/sim/common/riviera_files.tcl]
...
namespace eval ed_sim {
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [ed_sim_user_pll::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_user_pll/sim/"]]
    set design_files [dict merge $design_files [ed_sim_async_clk_source::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_async_clk_source/sim/"]]
    set design_files [dict merge $design_files [ed_sim_axil_driver_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_axil_driver_0/sim/"]]
    ...
    set design_files [dict merge $design_files [ed_sim_ref_clk_source_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_ref_clk_source_0/sim/"]]
    set design_files [dict merge $design_files [ed_sim_rrip::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_rrip/sim/"]]
    set design_files [dict merge $design_files [ed_sim_traffic_generator::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_traffic_generator/sim/"]]
    set design_files [dict merge $design_files [ed_sim_reset_handler::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_reset_handler/sim/"]]
    set design_files [dict merge $design_files [ed_sim_emif_io96b_lpddr4_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_emif_io96b_lpddr4_0/sim/"]]
    return $design_files
  }
  
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    set design_files [list]
    set design_files [concat $design_files [ed_sim_user_pll::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_user_pll/sim/"]]
    set design_files [concat $design_files [ed_sim_async_clk_source::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_async_clk_source/sim/"]]
    set design_files [concat $design_files [ed_sim_axil_driver_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_axil_driver_0/sim/"]]
    ...
    set design_files [concat $design_files [ed_sim_ref_clk_source_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_ref_clk_source_0/sim/"]]
    set design_files [concat $design_files [ed_sim_rrip::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_rrip/sim/"]]
    set design_files [concat $design_files [ed_sim_traffic_generator::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_traffic_generator/sim/"]]
    set design_files [concat $design_files [ed_sim_reset_handler::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_reset_handler/sim/"]]
    set design_files [concat $design_files [ed_sim_emif_io96b_lpddr4_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_emif_io96b_lpddr4_0/sim/"]]
